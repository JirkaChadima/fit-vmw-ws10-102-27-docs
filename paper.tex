...
V~součtech u~obrázku \ref{fig:borderflower} si můžeme také všimnout vždy obrovského příspěv-ku modrého kanálu. Opět jde o~efekt jedné velké špice, která vždy přispěje velkou měrou do celkového součtu.
